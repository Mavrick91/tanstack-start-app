        ...
        fields: [
          {
            ...
            render: (props: CustomFieldRenderProps) => (
              <IMaskInput
                ...
                className="flex h-9 w-full rounded-md border border-input bg-background px-3 py-1 text-sm shadow-xs placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-pink-500/40 focus-visible:ring-pink-500/25 focus-visible:ring-1 disabled:cursor-not-allowed disabled:opacity-50 transition-[color,box-shadow]"
              />
            ),
          },
        ],
